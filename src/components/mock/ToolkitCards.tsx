...
const TOOLS = [
  {
    ...
    body: "Paste the listing. Ally reads what they're asking for, pulls the matching bits out of your profile, and writes a short letter that sounds like you — not like a template.",
    art: <CoverLetterArt />,
  },
  {
    n: "02",
